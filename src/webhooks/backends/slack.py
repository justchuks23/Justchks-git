...
class SlackClient(WebHookBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.channels = [ch.strip() for ch in settings.SLACK_CHANNEL.split(',')]
        self.channels_unique_settings = settings.SLACK_CHANNELS_UNIQUE_SETTINGS
    ...
    def send(self, event_name: str, **kwargs):
        ...
        if self.payload['result']['name'] not in settings.NOT_SEND_MSG_TO_PUBLIC_CHANNEL_FOR_MEETINGS:
